...
class DeformConv2dWithActivation(torch.nn.Module):
    """
    Deform Convlution layer with activation (default activation:LeakyReLU)
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True,batch_norm=True, activation=torch.nn.LeakyReLU(0.2, inplace=True)):
        super(DeformConv2dWithActivation, self).__init__()
...
class DeformDeConv2dWithActivation(torch.nn.Module):
    """
    ...
    def __init__(self, scale_factor, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True, batch_norm=True,activation=torch.nn.LeakyReLU(0.2, inplace=True)):
        super(DeformDeConv2dWithActivation, self).__init__()
        self.conv2d = DeformConv2dWithActivation(in_channels, out_channels, kernel_size, stride, padding, dilation, groups, bias, batch_norm, activation)
